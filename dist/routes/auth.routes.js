...
userRoutes.post(
	...
	(0, globalValidation_1.GlobalValidation)(register_schema_1.registerSchema),
	register_controller_1.register
);
userRoutes.post(
	"/login",
	(0, globalValidation_1.GlobalValidation)(login_schema_1.LoginSchema),
